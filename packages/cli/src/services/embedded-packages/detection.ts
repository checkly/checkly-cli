...
export class DetectionUnavailableError extends Error {
   ...
   * failure occurred. Callers persist and apply these: every transmitted
   * package name should yield a durable verdict, so a retry never has to
   * send the same name again.
   */
