...
describe('playwright-config', () => {
  it('it should load simple config correctly', async () => {
    ...
    const config = new PlaywrightConfig(fixturesPath, pwConfig, 'simple-config.ts')
  ...
  it('it should load simple config correctly', async () => {
    ...
    const config = new PlaywrightConfig(fixturesPath, pwConfig, 'simple-config-no-browsers.ts')
